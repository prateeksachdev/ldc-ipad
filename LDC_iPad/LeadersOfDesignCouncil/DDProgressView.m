...
#define kProgressBarHeight  45.0f
...
- (void)drawRect:(CGRect)rect
{
	...
	CGFloat radius = 0.0f * rect.size.height ;  //	CGFloat radius = 0.5f * rect.size.height ;
	...
	radius = 0.0f * rect.size.height ;   //	radius = 0.5f * rect.size.height ;
